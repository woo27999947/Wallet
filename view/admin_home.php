<div class="jumbotron jumbotron-bg">
  <div class="container">
    <div class="row">
      <div class="col-xs-12 admin-home-table">
        <?php if (!defined("IN_WALLET")) { die("Auth Error!"); } ?>
        <?php
        if (!empty($error))
        {
            echo "<p style='font-weight: bold; color: rgba(255, 131, 0, 1);'>" . $error['message']; "</p>";
        }
        if (!empty($msg))
        {
            echo "<p style='font-weight: bold; color: rgba(77, 208, 225, 1);'>" . $msg['message']; "</p>";
        }
        ?>

        <a class="wallet-link col-xs-12 pl-pr-none" href="?">
          <img src="../assets/img/btn-back.svg" />
          <span>Go back to wallet</span>
        </a>

        <div class="table-hidden col-xs-12 pl-pr-none">
