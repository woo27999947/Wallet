...
class User {
	...
	//	global $hide_ids;
		...
		if (($id))
		{
			$msg = "<center class='twofa_bar'>Secret Key : $secret<br />
			OTP APP : <button type='submit' class='active-button btn_cyan' style='width:auto;height:auto;font-size:15px;margin-top:0;'><a href='https://play.google.com/store/apps/details?id=com.google.android.apps.authenticator2'>Download here</a></button><br />insert secret key your OTP APP's '+' Button</center>";
